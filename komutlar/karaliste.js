...
exports.run = async (client, message, args) => {
 if(message.author.id !== "985126554306773063") if(message.author.id !== "985126554306773063") return message.channel.send("hoop bilader sahip komutu bu");
  let user = args[0]
  ...
  .setFooter("RiseBunny")
  .setTimestamp()
  .setDescription(` <@${message.author.id}> adlı yetkilimiz tarafından karalisteye alındın! Artık RiseBunny'nin komutlarını kullanamazsın. Karalisteye alınma sebebin: **${sebep}**`)
